...
config.active_definition = BjondApi::BjondAppDefinition.new.tap do |app_def|
  ...
  app_def.iconURL      = ''
  app_def.configURL    = "http://#{Rails.application.config.action_controller.default_url_options[:host] || `hostname`}/bjond-app/services"
  app_def.rootEndpoint = "http://#{Rails.application.config.action_controller.default_url_options[:host] || `hostname`}/bjond-app/services"
